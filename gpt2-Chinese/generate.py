...
def main():
    ...
    parser.add_argument('--model_config', default='./gpt2-chinese/config.json', type=str, required=False, help='模型参数')
    parser.add_argument('--tokenizer_path', default='./gpt2-chinese/vocab.txt', type=str, required=False, help='词表路径')
    parser.add_argument('--model_path', default='./gpt2-chinese/', type=str, required=False, help='模型路径')

    parser.add_argument('--prefix', default='黑夜给了我黑色的眼睛', type=str, required=False, help='生成文章的开头')
